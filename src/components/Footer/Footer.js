    ...
    <div className='footer-main'>
      ...
      <div className='footer-social'>
        ...
        <div className='footer-social-description footer-info'>
          {
            footer.social.map(elem => (elem === 'facebook') ? <a href='https://www.facebook.com/'><FaFacebook className='footer-logo' color='#ffffff' size={45} /> </a> : (elem === 'instagram') ? <a href='https://www.instagram.com/' > <IoLogoInstagram className='footer-logo' size={50} color='#ffffff' /></a> : (elem === 'twitter') ? <a href='https://www.twitter.com/'><AiFillTwitterCircle className='footer-logo' size={50} color='#ffffff' /></a> : null)
          }
        </div>
      </div>
    </div >
